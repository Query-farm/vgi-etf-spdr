...
#
# Single image serving BOTH transports of the vgi-etf-spdr worker:
...
ARG SOURCE_URL=https://github.com/Query-farm/vgi-etf-spdr

LABEL org.opencontainers.image.title="vgi-etf-spdr" \
      org.opencontainers.image.description="SPDR (State Street) US ETF data as a VGI worker for DuckDB/SQL (stdio + HTTP)" \
